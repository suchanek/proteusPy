...
setup(name='proteusPy',
      ...
      install_requires=['numpy', 'matplotlib', 'pandas<2.0', 'pyvista[all,trame]', 'traitlets==5.9.0',
                        'notebook==6.4.12', 'jupyter', 'jupyterlab>=3', 'seaborn', 'pillow',
      ...
      package_data={'proteusPy': ['data/*.txt', 'data/*.py', 'data/*.json', 'data/*.csv', 'data/SS_consensus_class_sext.pkl']},
