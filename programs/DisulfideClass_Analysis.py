...
def analyze_classes(
    ...
    if all:
        ...
        analyze_binary_classes(
            loader, do_graph=do_graph, do_consensus=True, cutoff=cutoff, verbose=verbose
        )
    ...
    if binary:
        ss_classlist = analyze_binary_classes(
            loader, do_graph=do_graph, do_consensus=True, cutoff=0.1, verbose=verbose
        )
