...
class ManifoldObserver:
    ...
    def __init__(self, subject: ManifoldModel):
        ...
        self._lifted_data: Optional[np.ndarray] = None  # shape (n, N+1)
        self._observed: dict[str, ObservedGeometry] = {}
        self._curvature_field: Optional[np.ndarray] = None
    ...
    @property
    def lifted_data(self) -> Optional[np.ndarray]:
    ...
    def sync(self, node_id: Optional[str] = None) -> None:
